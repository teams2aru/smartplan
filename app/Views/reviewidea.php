        ...
        <div class="container logincontainer mb-5">
            <div class="row justify-content-md-center">
                <div class="col-7 mt-5">
                    ...
                    <?php endif; ?>
                    <form action="<?php echo base_url(); ?>/product/approveidea" method="post" enctype="multipart/form-data">
                        ...
                        <div id="personalinfo">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" name="ideastatus" id="region" required>
                                        <option value=""><?php echo $producttable['idea_status'] = null ? $producttable['idea_status'] : "Select Review"; ?></option>
